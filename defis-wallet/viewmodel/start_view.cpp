...
//QString StartViewModel::getLocalNodecac_symbol() const
//{
//    return AppModel::getInstance()->getSettings().getLocalNodecac_symbol();
//}
...
//void StartViewModel::setupLocalNode(int port, int miningThreads, const QString& cac_symbol, const QString& localNodePeer)
void StartViewModel::setupLocalNode(int port, int miningThreads, const QString& localNodePeer)
{
    ...
    //settings.setLocalNodecac_symbol(cac_symbol);
...
//QString StartViewModel::defaultcac_symbol() const
//{
//  return "XGM";
//}
