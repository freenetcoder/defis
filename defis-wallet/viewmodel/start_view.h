...
class StartViewModel : public QObject
{
    ...
    // Q_PROPERTY(QString localNodecac_symbol READ getLocalNodecac_symbol CONSTANT)
...
bool getUseGpu() const;
  ...
  //  Q_INVOKABLE void setupLocalNode(int port, int miningThreads, const QString& cac_symbol, const QString& localNodePeer);
  ...
  //  Q_INVOKABLE QString defaultcac_symbol() const;
