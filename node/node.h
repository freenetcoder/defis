...
struct Node
{
	...
	struct Config
	{
		...
		unsigned long long m_cac_premine = 10000000000;
		unsigned long long m_cac_blockreward = 10000000000;
		unsigned long long m_cac_drop0 = 525600;
		unsigned long long m_cac_drop1 = 2102400;
		unsigned int m_cac_coinbasematurity = 90;
		unsigned int m_cac_standartmaturity = 0;
		unsigned int m_cac_blocktime = 60;
...
private:
	...
	struct Miner
	{
		...
		struct External
		{
			...
			Task::Ptr m_ppTask[128]; // backlog of potentially being-mined currently
