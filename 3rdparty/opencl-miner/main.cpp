...
int main(int argc, char* argv[]) {
	...
	cout << "====================================" << endl;
	cout << "  XGM Equihash 150/5 OpenCL miner  " << endl;
	cout << "====================================" << endl;
	...
	if (parsing != 0) {
		...
		cout << " --server <server>:<port>	The XGM stratum server and port to connect to (required)" << endl;
		cout << " --key <key>			The XGM stratum server API key (required)" << endl;
